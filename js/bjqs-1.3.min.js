      ...
      x = function () {
        ...
        if (r.centercontrols) {
          ...
          var t = (i.height() - a.children("a").outerHeight()) / 2,
            n = (t / r.height) * 100,
            s = n + "%";
          a.find("a").css("bottom", "20px");
          f.find("a").css("bottom", "20px");
        }
      },
      T = function () {
        ...
        if (!v.animating) {
          ...
          if (r.animtype === "slide") {
            if (r.showmarkers) {
              ...
              n === v.slidecount - 2
                ? (n = 0)
                : n === -1 && (n = v.slidecount - 3);
              c.removeClass("active-marker");
              c.eq(n).addClass("active-marker");
            }
            r.responsive && m.width < r.width
            ...
            s.animate(
              ...
              function () {
                ...
                if (o.eq(v.currentindex).attr("data-clone") === "last") {
                  ...
                  o.eq(v.currentindex).attr("data-clone") === "first"
                ) {
